...
def step_impl(context):
    path_scenario = r"C:\Users\MALU\Downloads\OldfashionedRottenMenus\UI_Automation_Demo\data\Scenario1.csv"  # Path to fetch Scenario file
